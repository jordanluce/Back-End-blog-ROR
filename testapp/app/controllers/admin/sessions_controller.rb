class Admin::SessionsController < Admin::ApplicationController
  ...
  def create
  	...
  	redirect_to admin_moderators_url, notice:'You have succesfully signed in'
		else 
			flash[:alert] = 'There was a problem with the username or password'
			render :new
		end
  end
  ...
  def destroy
  	...
  	redirect_to '/login', notice: 'You have succesfully logout'
  end
end
